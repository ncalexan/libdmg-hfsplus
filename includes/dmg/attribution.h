 ...
 * - a single type BZ_RAW raw block
 * - an "attribution" resource in its XML plist describing the raw block
 *
 ...
 */
  ...
  // to the same number of bytes.
	...
	/* 			<string>Driver Descriptor Map (DDM : 0)</string> */
	/* 		</dict> */
  // THESE cSum checksums CAN BE SKIPPED ENTIRELY!
  // Then there's an independent cSum key, which has some proprietary hash.
  // - XXX NOT DONE
